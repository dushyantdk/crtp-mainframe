        ...
        <section className="job-details">
            <div className="container">
                ...
                <p className="font-weight-bold mb-0">WHAT YOU’LL BE DOING:</p>
                        ...
                        <ul>
                            <li className="mt-2">•	Assist in the preparation and monitoring of annual budget and forecasts</li>
                            <li className="mt-2">•	Preparation of reports to regulators</li>
                            <li className="mt-2">•	Supervision and monitoring of daily cash management activities of finance department</li>
                            <li className="mt-2">•	Supervision and implementation of department internal procedures and processes</li>
                            <li className="mt-2">•	Responsible for the organization and management of team</li>
                            <li className="mt-2">•	Provide guidance and support for project automations</li>
                            <li className="mt-2">•	Process incoming and out coming payments</li>
                            <li className="mt-2">•	Ensure appropriate controls are in place for cash management activities</li>
                            <li className="mt-2">•	Liaising with the company’s bankers</li>
                            <li className="mt-2">•	Reporting to the management</li>
                            <li className="mt-2">•	Collaborate effectively and efficiently with company’s departments</li>
                            <li className="mt-2">•	Assisting in preparation of various management reports</li>
                            <li className="mt-2">•	Offer support in accounting, taxation and financial matters to the company’s management</li>
                            <li className="mt-2">•	Supervising and reviewing due diligence for counterparties, banks and liquidity providers</li>
                        </ul>
                        <p className="font-weight-bold mb-0">REQUIREMENTS:</p>
                        
                        <ul>
                            <li className="mt-2">•	4 years of previous working experience in a managerial position within the Forex industry</li>
                            <li className="mt-2">•	Qualified accountant (ACA, ACCA, CPA or equivalent) and degree/master in financial related</li>
                            <li className="mt-2">•	Experience of working in an international/cross border environment </li>
                           <li className="mt-2"> •	Strong accounting and financial background</li>
                           <li className="mt-2">•	Multitasking skills with a strong attention to detail</li>
                           <li className="mt-2">•	Strategic and analytical thinking, problem solving and goal oriented </li>
                           <li className="mt-2">•	Excellent English communication skills.</li>
                        </ul>
                        <p className="font-weight-bold mb-0">ADVANTAGES: </p>
                        
                        <ul>
                            <li className="mt-2">•	Knowledge of Priority (ERP)</li>
                            <li className="mt-2">•	Good self-discipline, good communication skills, team player, attention to details</li>
