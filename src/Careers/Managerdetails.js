        ...
        <section className="job-details">
            <div className="container">
                ...
                <p className="font-weight-bold mb-0">WHAT YOU’LL BE DOING:</p>
                        ...
                        <ul>
                             <li className="mt-2">•	Establish & implement a best-in-class transportation strategy</li>
                             <li className="mt-2">•	Build mechanisms to stay connected to all internal & external stakeholders</li>
                             <li className="mt-2">•	Build a deep knowledge of current industry standards and challenges</li>
                             <li className="mt-2">•	Create scalable & transparent reporting mechanisms</li>
                             <li className="mt-2">•	Communicate and report out on a daily basis.</li>
                        </ul>
                        <p className="font-weight-bold mb-0">REQUIREMENTS:</p>
                        
                        <ul>
                             <li className="mt-2">•	Bachelor's degree in Business Administration, Logistics, Supply Chain, or related degree</li>
                             <li className="mt-2">•	Experience managing a product or service launch</li>
                             <li className="mt-2">•	Experience working with large cross-functional teams</li>
                            <li className="mt-2"> •	Experience solving problems through root cause analysis techniques</li>
                            <li className="mt-2">•	Experience working with key stakeholders across various teams (ie Technology, Legal, or Finance)</li>
                            <li className="mt-2">•	Excellent English communication skills.</li>
                        </ul>
                        <p className="font-weight-bold mb-0">ADVANTAGES: </p>
                        
                        <ul>
                             <li className="mt-2">•	MBA preferred</li>
                             <li className="mt-2">•	Proficiency at querying and architecting relational databases (SQL, ETL)</li>
                             <li className="mt-2">•	Experience reporting and interpreting large sets of data with accompanying business insights</li>
                             <li className="mt-2">•	Business Analyst/Project Management experience</li>
                             <li className="mt-2">•	Ability to find practical and simple solutions to complicated problems without sacrificing quality or core functionality</li>
                             <li className="mt-2">•	Flexibility and versatility. </li>
                        </ul>
